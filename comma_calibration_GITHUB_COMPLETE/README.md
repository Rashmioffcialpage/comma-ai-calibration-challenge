...
![Video 2 pitch](results/plots/video_2_pitch.png)

### Example Dashcam Frame

![Video 0 sample frame](results/frames/video_0_sample.png)

All plots are generated reproducibly with:

```bash
python src/make_results.py --data /path/to/data --out results
```

The generated `results/validation_scores.csv` contains the per-fold scores used in the summary chart.
